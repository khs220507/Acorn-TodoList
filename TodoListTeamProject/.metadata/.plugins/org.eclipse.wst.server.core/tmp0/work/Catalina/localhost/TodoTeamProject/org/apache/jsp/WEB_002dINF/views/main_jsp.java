 ...
 * Generated at: 2023-09-22 08:11:52 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script>\r\n");
      out.write("\r\n");
      out.write("	function starList() {\r\n");
      out.write("		$\r\n");
      out.write("				.ajax({\r\n");
      out.write("					type : \"get\",\r\n");
      out.write("					url : \"/TodoTeamProject/starData\",\r\n");
      ...
      out.write("													+ this.code\r\n");
      out.write("													+ ')\">수정</button><button>삭제</button></div></div>';\r\n");
      out.write("											output += '</span>';\r\n");
      out.write("										});\r\n");
      ...
      out.write("		$(this).closest('span').remove();\r\n");
      out.write("		let code = $(this).closest('span').find('.code').text().trim();\r\n");
      out.write("		deleteList(code);\r\n");
      out.write("\r\n");
      out.write("	});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("	/* if (this.star == 'T') {\r\n");
      out.write("		$('#' + this.code).prop('checked', true);\r\n");
      out.write("		$('input:checkbox[name=\"starCheckBox\"]').prop('checked', true);\r\n");
      out.write("	} else {\r\n");
      out.write("		$('#' + this.code).prop('checked', false);\r\n");
      out.write("		$('input:checkbox[name=\"starCheckBox\"]').prop('checked', false);\r\n");
      out.write("	} */\r\n");
      out.write("\r\n");
      out.write("	function changeStar(obj) {\r\n");
      out.write("\r\n");
      out.write("		let span = obj.parentElement.parentElement.parentElement;\r\n");
      out.write("		let code = span.querySelector(\".code\").innerHTML;\r\n");
      out.write("		let starflag = span.querySelector(\".starflag\").innerHTML;\r\n");
      out.write("		let idcode = span.getAttribute(\"id\");\r\n");
      out.write("	\r\n");
      out.write("		if (starflag == \"T\") {\r\n");
      out.write("			$('#'+ idcode).prop('checked', true);\r\n");
      out.write("			$('input:checkbox[name=\"starCheckBox\"]').prop('checked', true);\r\n");
      out.write("		} else {\r\n");
      out.write("			$('#'+ idcode).prop('checked', false);\r\n");
      out.write("			$('input:checkbox[name=\"starCheckBox\"]').prop('checked', false);\r\n");
      out.write("		}\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			type : \"post\",\r\n");
      out.write("			url : \"/TodoTeamProject/updateStarflag\",\r\n");
      out.write("			dataType : \"text\",\r\n");
      out.write("			data : \"code=\" + code + \"&starflag=\" + starflag,\r\n");
      out.write("			success : function(date) {\r\n");
      out.write("				window.location.reload();\r\n");
      out.write("			},\r\n");
      out.write("			error : function(jqXHR, textStatus, errorThrown) { // 에러 핸들링 추가\r\n");
      out.write("				alert(\"에러 발생: \" + textStatus + \" - \" + errorThrown);\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("	}\r\n");
      out.write("\r\n");
      ...
      out.write("											output += this.code + \"</p>\";\r\n");
      out.write("											output += '<p class=\"starflag\">';\r\n");
      out.write("											output += this.star + \"</p>\";	\r\n");
      out.write("											output += '<div class=\"toDo\"><input type=\"checkbox\" class=\"checkBox\"><label for=\"toDo2\">';\r\n");
      out.write("											output += this.contents;\r\n");
      out.write("											output += '</label><div class=\"wrapButton\"><button onclick=\"selectContents('\r\n");
      out.write("													+ this.code\r\n");
      out.write("													+ ')\">수정</button><button class=\"deleteButton\">삭제</button>'\r\n");
      out.write("													+ '<input type=\"checkbox\" class=\"aaa\"  id=\"' + this.code + '\">'\r\n");
      out.write("													+ '<label onclick=\"javascript:changeStar(' + this.code + ')\" for=\"' + this.code + '\" class=\"star\"></label>'\r\n");
      ...
      out.write("													+ this.code\r\n");
      out.write("													+ ')\">수정</button><button class=\"deleteButton\">삭제</button>'\r\n");
      out.write("													+ '<input type=\"checkbox\" class=\"aaa\" name=\"starCheckBox\" id=\"' + this.code + '\">'\r\n");
      out.write("													+ '<label onclick=\"javascript:changeStar('\r\n");
      out.write("													+ 'this'\r\n");
      out.write("													+ ')\" for=\"'													\r\n");
      out.write("													// 떠라2\r\n");
      out.write("													 + this.code + '\" class=\"' + (this.star === \"T\" ? \"star2\" : \"star1\") + '\"></label>'												\r\n");
      out.write("											output += '</div></div>';\r\n");
      out.write("											output += '</span>';\r\n");
      out.write("										});\r\n");
      out.write("						document.getElementById('disp').innerHTML = output;\r\n");
      out.write("						switchStar();\r\n");
      out.write("					}\r\n");
      out.write("				});\r\n");
      out.write("	};\r\n");
      out.write("\r\n");
      out.write("	/* function switchStar() {\r\n");
      out.write("\r\n");
      out.write("	 if (this.star == 'T') {\r\n");
      out.write("	 $('#' + this.code).prop('checked', true);\r\n");
      out.write("	 $('input:checkbox[name=\"starCheckBox\"]').prop('checked', true);\r\n");
      ...
      out.write("\r\n");
      out.write("	/* function switchStar() {\r\n");
      out.write("		// 각 항목에 대한 별 표시 여부를 확인하고 체크박스의 상태를 업데이트합니다.\r\n");
      out.write("		$('input:checkbox[name=\"starCheckBox\"]').each(function() {\r\n");
      out.write("			var code = $(this).attr('id');\r\n");
      out.write("			var starFlag = $(this).prop('checked');\r\n");
      out.write("			if (starFlag) {\r\n");
      out.write("				$(this).siblings('.star').text('T');\r\n");
      out.write("			} else {\r\n");
      out.write("				$(this).siblings('.star').text('F');\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("	} */\r\n");
      out.write("\r\n");
      ...
      out.write("			<p class=\"title\", id=\"title\">To Do</p>\r\n");
      out.write("\r\n");
      ...
      out.write("						alt=\"sun--v1\" /> <a href=\"javascript:starList()\">중요</a>\r\n");
      out.write("				</div>\r\n");
      out.write("\r\n");
      out.write("				<div class=\"wrapMenu\">\r\n");
      out.write("					<img width=\"17px\" height=\"17px\"\r\n");
      ...
      out.write("						alt=\"sun--v1\" /> <a href=\"\" onclick=\"\">완료된 일정</a>\r\n");
      out.write("				</div>\r\n");
      out.write("\r\n");
      out.write("				<hr>\r\n");
      out.write("\r\n");
      ...
      out.write("						alt=\"sun--v1\" /> <a href=\"/TodoTeamProject/inquiryM\">To Do Memo</a>\r\n");
      out.write("				</div>\r\n");
      out.write("			</nav>\r\n");
      out.write("\r\n");
      out.write("			<section>\r\n");
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("	//5초뒤에 검색내용 사라지게\r\n");
      out.write("	let searchResult = document.querySelector('#searchResult');\r\n");
      out.write("\r\n");
      out.write("	if (searchResult) {\r\n");
      out.write("		function hideResult() {\r\n");
      out.write("			searchResult.classList.add('hidden');\r\n");
      out.write("		}\r\n");
      out.write("\r\n");
      out.write("	}\r\n");
      out.write("\r\n");
      out.write("	setTimeout(hideResult, 3000);\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/main.jsp(608,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/main.jsp(612,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/main.jsp(615,7) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/main.jsp(615,7) '${searchResults}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${searchResults}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/main.jsp(615,7) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
